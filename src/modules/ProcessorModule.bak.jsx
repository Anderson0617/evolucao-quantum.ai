      ...
      <div className="processor-content">
        ...
        <div className="processor-grid">
          ...
          >
            ...
            <div className="processor-card-body">
              <h3 className="processor-card-title">Microscópico e Preciso</h3>
              <p className="processor-card-text">
                Trilhas microscópicas vibram a gigahertz, mantendo instruções e
                caches sincronizados enquanto a temperatura oscila próximo do
                limite seguro.
              </p>
            </div>
          </article>
          ...
          <div className="processor-card board-card">
            ...
            <p className="processor-card-text">
              Ao comandar o fluxo, relés virtuais e barramentos liberam uma onda
              de dados comprimidos — o clique confirma a latência mínima.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="capacity-panel">
            ...
            <p className="sr-only">
              Parallax ativo: a imagem do data center aproxima-se conforme você
              explora a seção.
            </p>
          </div>
        </aside>
